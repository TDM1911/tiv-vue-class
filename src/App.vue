<template>
  <section>
    ...
    <add-friend-form @create-new-friend="createNewFriend"></add-friend-form>
...
export default {
  ...
  methods: {
    toggleFavorite(index) {
      let friend = this.friends.find(function(value) {
